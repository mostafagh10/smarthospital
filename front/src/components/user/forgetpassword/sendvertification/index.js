...
import { confirmverificationcodeprocess } from '../../../admin/APIs/forgetpasswordAPI'
  ...
  const handlechange = (e) => {
    ...
    const handlesubmit = (e) => {
        ...
        const {email , verificationCode} = formdata;
          ...
          confirmverificationcodeprocess(data).then((response) => {
            console.log('axios sendemail success' , response)
            history.push('/forgetpassword/changepassword')
            setformdata({
              email:'',
              verificationCode:'',

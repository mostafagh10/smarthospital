...
import { doctorsendverificationcodeprocess } from '../../../admin/APIs/forgetpasswordAPI'
import {failedmessage , successmessage} from '../../../admin/helpers/messages'
import {useHistory} from 'react-router-dom'

const SendEmailDoctor = () => {
  ...
  const handlechange = (e) => {
    ...
    const handlesubmit = (e) => {
        ...
        const {email} = formdata;
          ...
          doctorsendverificationcodeprocess(data).then((response) => {
            console.log('axios sendemail success' , response)
            history.push('/forgetpassword/doctor/sendvertification')
            setformdata({
              email:'',

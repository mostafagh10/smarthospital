...
import { doctorconfirmverificationcodeprocess } from '../../../admin/APIs/forgetpasswordAPI'
import {failedmessage , successmessage} from '../../../admin/helpers/messages'
import {useHistory} from 'react-router-dom'

const SendVerificationDoctor = () => {
  ...
  const handlechange = (e) => {
    ...
    const handlesubmit = (e) => {
        ...
        const {email , verificationCode} = formdata;
          ...
          doctorconfirmverificationcodeprocess(data).then((response) => {
            console.log('axios sendemail success' , response)
            history.push('/forgetpassword/doctor/changepassword')
            setformdata({
              email:'',
              verificationCode:'',
...
export default SendVerificationDoctor;